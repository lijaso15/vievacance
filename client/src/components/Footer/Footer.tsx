...
const Footer = ({ viewer }: FooterProps) => {
  return (
              ...
              <ul className="link-list">
                ...
                <li>
                  <a
                    id="footer-links"
                    style={{ color: "hsl(0, 0%, 71%)" }}
                    href={viewer ? "/profile" + "/" + viewer : "/homeglobe"}
                  >
                    Profile
                  </a>
                </li>
                ...
                <nav className="level is-mobile">
                  <div className="level-left">
                    <a
                      ...
                      href="https://lijaso15.github.io/"
                    >
                      <FontAwesomeIcon
                        style={{ color: "hsl(48, 100%, 67%)" }}
                        icon={["fab", "github"]}
                      />
                    </a>
                    <a
                      className="level-item"
                      href="https://www.linkedin.com/in/jason-li-32652b162/"
                    >
                      <FontAwesomeIcon
                        style={{ color: "hsl(48, 100%, 67%)" }}
                        icon={["fab", "linkedin"]}
